<template>
  <div class="loader-wrap">
	...
	c0,0,5.515-0.765,5.515-5.515s0-30.75,0-45.47S17.905,38.109,17.905,38.109z"
            ></path>
            <mask id="bottle_mask">
              <use x="0" y="0" xlink:href="#bottle" opacity="1" fill="#ffffff"></use>
            </mask>
          </defs>
          <rect
            class="bottle-fill"
	...
	C29.003,82.919,30.919,51.503,30.836,48.086z"
            ...
            <mask id="bottle_mask_2">
              <use x="0" y="0" xlink:href="#bottle_2" opacity="1" fill="#ffffff"></use>
            </mask>
          </defs>
          <rect
            class="bottle-fill"
	...
	S31.157,64.254,29.157,53.497z"
            ...
            <mask id="bottle_mask_3">
              <use x="0" y="0" xlink:href="#bottle_3" opacity="1" fill="#ffffff"></use>
            </mask>
          </defs>
          <rect
            class="bottle-fill"
	...
	c1.625,0,4.971,0,8,0c4.188,0,3.75-8.625,2.813-14S26.038,52.878,25.474,44.253z"
            ...
            <mask id="bottle_mask_4">
              <use x="0" y="0" xlink:href="#bottle_4" opacity="1" fill="#ffffff"></use>
            </mask>
          </defs>
          <rect
            class="bottle-fill"
